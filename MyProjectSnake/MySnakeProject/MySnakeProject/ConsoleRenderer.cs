...
namespace Shared
{
    internal class ConsoleRenderer
    {
        ...
        public void SetUnitPixel(Unit unit)
        {
            _pixels[unit.CurrentPosition.X, unit.CurrentPosition.Y] = unit.View;
            _pixelColors[unit.CurrentPosition.X, unit.CurrentPosition.Y] = unit.UnitColorID;
        }
