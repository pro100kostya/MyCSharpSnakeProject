...
namespace Shared
{
    internal class ConsoleRenderer
    {
        ...
        public void SetPixel(IDrawable drawable)
        {
            _pixels[drawable.position.X, drawable.position.Y] = drawable.view;
            _pixelColors[drawable.position.X, drawable.position.Y] = drawable.colorId;
        }
